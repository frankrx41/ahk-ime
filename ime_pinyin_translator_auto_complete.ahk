...
PinyinTranslatorInsertAutpComplete(ByRef translate_result, splitter_result)
{
    ...
    splitted_string := SplitterResultArrayConvertToString(splitter_result, 1)
    splitted_string .= "*"
    ...
    profile_text := "[""" SplitterResultArrayConvertToString(splitter_result, 1) """] -> [""" splitted_string """," take_up_length "]"
