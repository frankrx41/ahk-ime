...
PinyinSplitterInputStringFluent(input_string)
{
    ...
    loop
    {
        ...
        if( IsInitials(SubStr(initials,1,1)) || IsInitialsAnyMark(initials) )
        {
            ...
            initials    := PinyinSplitterParseInitials(input_string, fluent_initials, string_index, "FluentToNormal")
            vowels      := PinyinSplitterParseVowels(input_string, initials, string_index, prev_splitted_input, "FluentToNormal", 4)
